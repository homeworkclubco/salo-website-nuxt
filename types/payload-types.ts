...
export interface Page {
  ...
  meta?: {
    ...
    /**
     * Override the canonical URL (leave blank to use default)
     */
...
export interface SiteSetting {
  ...
  general: {
    ...
    siteName: string;
    /**
     * The full URL of your website (e.g., https://salo.com)
     */
    siteUrl: string;
  };
  seo?: {
    /**
     * Default title for pages without a specific SEO title
     */
